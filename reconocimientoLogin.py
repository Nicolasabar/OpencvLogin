...
def reconocimientoRostro(nombremodelo):
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            # El modelo de reconocimiento entiende que el tamano de imagenes que se le entregan son todas del mismo tamano 150x150
        ...
        if k == 27 or validar == True:
            ...
            print('')
            print('**************************************')
            print('************Bienvenido {}**********'.format(nombremodelo))
            print('**************************************')
            print('       *')
            print('     *****')
            print('   ********')
